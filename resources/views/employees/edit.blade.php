...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('update', $employee->id) }}" enctype="multipart/form-data">
            ...
            <div class="mt-5 mb-4">
                ...
                <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" id="day_of_birth" name="day_of_birth"
                            value="{{ Carbon\Carbon::parse($employee->day_of_birth)->format('d M Y') }}"
                            class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    </div>
                </div>
                <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                ...
                <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                    <div class="w-full">
                        ...
                        <input type="text" id="religion" name="religion" value="{{ $employee->religion }}"
                            class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="marital_status"
                            value="{{ $employee->marital_status == 1 ? 'Yes' : 'No' }}"
                            class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    </div>
                </div>
                <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="expected_salary"
                            value="{{ number_format($employee->expected_salary, 3) }}"
                            class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    </div>
                </div>
                <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="nrc" value="{{ $employee->nrc }}" readonly
                            class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    </div>
                </div>
            ...
            <div class="mb-4">
                <h2 class="text-xl font-semibold">Edit Working Experience</h2>
                @for ($i = 0; $i < count($employee->workingExperiences); $i++)
                    <input type="hidden" name="experience_id"
                        value="{{ $employee->workingExperiences[$i]->id }}">
                    ...
                    <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="company_name" name="company_name[]"
                                value="{{ $employee->workingExperiences[$i]->company_name }}"
                                class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                        <div class="w-full">
                            ...
                            <input type="text" name="job_title[]"
                                value="{{ $employee->workingExperiences[$i]->job_title }}"
                                class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col justify-center items-center mt-5 grid grid-cols-2 gap-4">
                        <div class="w-full">
                            ...
                            <input type="text" id="department" name="department[]"
                                value="{{ $employee->workingExperiences[$i]->department }}"
                                class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                        <div class="w-full">
                            ...
                            <input type="text" name="project_link[]"
                                value="{{ $employee->workingExperiences[$i]->project_link }}"
                                class="mt-2 w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                    </div>
                @endfor
            </div>
            <button type="submit" class="rounded-lg px-4 py-2 bg-green-500 text-white">Update Employee</button>
        </form>
    </div>
@endsection
